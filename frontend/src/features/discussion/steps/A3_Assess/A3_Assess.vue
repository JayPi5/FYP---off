<template>
  <StepTalk
    :main-variants="[
      ...
      `Part of me wants to quit... the other part prefers smoking.`,
      `My brain says 'yes,' but my hand lights up anyway.`
    ]"
    explanation="Help the bird with an advise for it health."
    :buttons="[
